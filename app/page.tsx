...
import { Play, Pause, Calendar, MapPin, Instagram, Twitter, Youtube, AirplayIcon as Spotify, Link, Facebook } from "lucide-react"
...
export default function SingerPortfolio() {
  ...
  const albums = [
    {
      ...
      tracks: [
        ...
        { title: "Pani Paryo", link: "https://youtu.be/VKeGxIPoleg?si=8CKJiyO8BUEpbRKA" },
        { title: "Timi Nai", link: "https://youtu.be/x-1BAzBSDOQ?si=STM98DGcoTEqSGd5" },
      ],
      duration: "17:31",
      genre: "",
    },
    {
      ...
      tracks: [
        { title: "Bidaai", link: "https://youtu.be/s9sEKEpFNQ8?si=B4u-Tg6Q-OK5twle" },
        { title: "Badal", link: "https://youtu.be/v9HvwMPWMfs?si=H7BFgeKhTlH1OplI" },
        { title: "Chahana", link: "https://youtu.be/07Y4aRVQngE?si=udc6bMxpDVW0jMTY" },
        { title: "Jooni Jooni", link: "https://youtu.be/VMme3dXf8WA?si=2NR4tCRFPEPPbPRK" },
      ],
      duration: "18:52",
      genre: "",
    },
    {
      ...
      tracks: [
        { title: "Sannani", link: "https://youtu.be/cDIDL3cDuJc?si=2WWThkq7agH14Ara" },
        { title: "Sapani Ma", link: "https://youtu.be/p3IIdLNkCis?si=L1SyPVkDDizF15LT" },
        { title: "Nayan Ma", link: "https://youtu.be/gKOHprU827E?si=Vo-0gVioBTOuNbhr" },
        { title: "Har Sas", link: "https://youtu.be/UCokM6haT68?si=1Lc5UHwe5KPh78Jm" },
      ],
      duration: "16:46",
      genre: "",
    },
  ...
  const tours = [
    { date: "Dec 15, 2025", venue: "Pragya Pratisthan", city: "Kathmandu, Nepal" },
    ...
    <div className="min-h-screen bg-black text-white overflow-x-hidden">
      ...
      <div className="fixed inset-0 z-0">
        ...
        <div
          ...
          style={{
            backgroundImage: `radial-gradient(circle at ${50 + scrollY * 0.01}% ${50 + scrollY * 0.005}%, rgba(139, 92, 246, 0.1) 0%, transparent 50%)`,
          }}
        />
      </div>
        ...
        <div className="container mx-auto px-6 py-4">
          <div className="flex items-center justify-between">
            ...
            <div className="hidden md:flex space-x-8">
              ...
              <a href="#music" className="hover:text-purple-400 transition-colors">
                Music
              </a>
              <a href="#tours" className="hover:text-purple-400 transition-colors">
                Tours
              </a>
      ...
      <section id="home" className="relative min-h-screen flex items-center justify-center z-10">
        <div className="text-center space-y-8 px-6">
          ...
          <a href="https://open.spotify.com/artist/5CzMXgbioXfdYjkS0Kpqcu?si=OoXOVosxQwuL80b983oQMw" target="_blank" rel="noopener noreferrer">
    ...
    <div className="grid md:grid-cols-2 gap-12 items-center mb-16">
      <div className="space-y-6">
        ...
        <p className="text-lg text-gray-300 leading-relaxed">
          Rohit Jung Chettri is a renowned Nepali singer and songwriter known for his soulful voice and
          contemporary approach to Nepali music. His unique blend of traditional Nepali melodies with modern
          production has captivated audiences across Nepal and beyond.
        </p>
        <p className="text-lg text-gray-300 leading-relaxed">
          With multiple hit albums and countless live performances, he has established himself as one of the
          leading voices in contemporary Nepali music, touching hearts with his emotional depth and musical
          versatility.
        </p>
        <div className="flex flex-wrap gap-3">
          ...
          <Badge variant="secondary" className="bg-blue-900/50 text-blue-300 border-blue-400">
            Contemporary
          </Badge>
          <Badge variant="secondary" className="bg-pink-900/50 text-pink-300 border-pink-400">
            Acoustic
          </Badge>
          <Badge variant="secondary" className="bg-teal-900/50 text-teal-300 border-teal-400">
            World Music
          </Badge>
        </div>
      </div>
            ...
            {albums.map((album, index) => (
              ...
              >
                <CardContent className="p-6">
                  ...
                  <p className="text-sm text-gray-500 mb-3">Duration: {album.duration}</p>

                   {/* Track List */}
                  <div className="space-y-2">
                    <h4 className="text-sm font-semibold text-purple-400">Tracks:</h4>
  ...
  <Card className="bg-white/5 backdrop-blur-md border-white/10">
    <CardContent className="p-8">
      ...
      <p className="text-gray-300 mb-6">
        Follow me on social media for the latest updates, behind-the-scenes content, and new music releases.
      </p>
      <div className="grid grid-cols-2 gap-4">
        <Button 
          className="bg-gradient-to-r from-pink-600 to-red-600 hover:from-pink-700 hover:to-red-700 justify-start"
          onClick={() => window.open('https://www.instagram.com/rohit.john.chettri/?hl=en', '_blank')}
        >
        ...
        <Button 
          ...
          onClick={() => window.open('https://www.facebook.com/rohitjohnchettri/', '_blank')}
        >
        ...
        <Button 
          ...
          onClick={() => window.open('https://www.youtube.com/channel/UCNhLcFjUtFaOtsCwbQ8lQsw', '_blank')}
        >
        ...
        <Button 
          ...
          onClick={() => window.open('https://open.spotify.com/artist/5CzMXgbioXfdYjkS0Kpqcu?si=OoXOVosxQwuL80b983oQMw', '_blank')}
        >
